...
@section('content')
    <div class="container" id="detail-page">
        ...
        <div class="film-info" itemscope itemtype="https://schema.org/Movie">
            <!-- Thay đổi để sử dụng class và data-background thay vì inline style để áp dụng lazy loading cho background -->
            <div class="image lazyload" data-bg="{{ $currentMovie->getPosterUrl() }}">
                <!-- Áp dụng lazy loading cho ảnh phim chính -->
            ...
            <div class="text">
                <div class="social">
                    ...
                    <div class="box-rating">
                        ...
                        <!-- Thêm lazy loading cho ảnh schema.org -->
                        <img class="hidden lazyload" itemprop="thumbnailUrl"
                            data-src="{{ $currentMovie->getPosterUrl() }}"
                            src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                    ...
                    @foreach ($movie_related as $movie)
                        <li class="item ">
                            ...
                            <a title="{{ $movie->name }} - {{ $movie->origin_name }}" href="{{ $movie->getUrl() }}">
                                <!-- Đã có lazy loading nhưng thiếu src placeholder -->
...
@push('scripts')
    ...
    <script>
        $(function() {
            ...
            // Khởi tạo lazy load cho background
            // Điều này cần thêm CSS và JS cho lazysizes-bg
        })
    </script>
