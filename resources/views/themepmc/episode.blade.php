...
@section('content')
    <div class="container" id="page-player">
        ...
        <div class="box-rating">
            ...
            <span id="hint"></span>
            <!-- Thay đổi hình ảnh schema.org để sử dụng data-src thay vì src -->
        ...
        <div class="film-info">
            ...
            <!-- Thay đổi hình ảnh schema.org ẩn để sử dụng lazy loading -->
            <img class="hidden lazyload" itemprop="thumbnailUrl"
                data-src="{{ $currentMovie->getPosterUrl() }}"
                src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                alt="{{ $currentMovie->name }}-{{ $currentMovie->origin_name }}"> 
                    ...
                    @foreach ($movie_related as $movie)
                        <li class="item ">
                            ...
                            <a title="{{ $movie->name }} - {{ $movie->origin_name }}" href="{{ $movie->getUrl() }}">
                                <!-- Phần này đã có lazy loading nhưng thiếu src placeholder -->
        ...
        function renderPlayer(type, link, id) {
            ...
            if (type == 'm3u8' || type == 'mp4') {
                ...
                const objSetup = {
                    ...
                    aspectratio: "16:9",
                    width: "100%",
                    // Thay đổi image thành data-image để tránh tải trước
