...
@section('content')
    <div class="container" id="page-player">
        ...
        <div class="box-rating">
            ...
            <span id="hint"></span>
            <!-- Thay đổi hình ảnh schema.org để sử dụng hình ảnh tối ưu -->
            ...
            <img class="hidden lazyload" itemprop="image"
                src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                data-src="{{ \App\Helpers\OptimizedImage::get($currentMovie->getPosterUrl(), 'medium') }}"
                alt="{{ $currentMovie->name }} {{ $currentMovie->origin_name }}">
        ...
        <div class="film-info">
            ...
            <!-- Thay đổi hình ảnh schema.org ẩn để sử dụng hình ảnh tối ưu -->
            <img class="hidden lazyload" itemprop="thumbnailUrl"
                src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                data-src="{{ \App\Helpers\OptimizedImage::get($currentMovie->getPosterUrl(), 'medium') }}"
                alt="{{ $currentMovie->name }}-{{ $currentMovie->origin_name }}"> 
        ...
        function renderPlayer(type, link, id) {
            ...
            if (type == 'm3u8' || type == 'mp4') {
                ...
                const objSetup = {
                    ...
                    aspectratio: "16:9",
                    width: "100%",
                    // Sử dụng placeholder ban đầu để tránh tải trước poster kích thước lớn
                    image: "{{ asset('img/player-placeholder.jpg') }}",
                    file: link,
                ...
                player.on('ready', function() {
                    ...
                    // Thêm mã mới: đặt poster tối ưu sau khi player đã load xong
                    player.setConfig({
                        image: "{{ \App\Helpers\OptimizedImage::get($currentMovie->getPosterUrl(), 'large') }}"
                    });
                });
